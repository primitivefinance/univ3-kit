...
pub mod pair_flash {
    ...
    impl<M> ::core::fmt::Debug for PairFlash<M> {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple(::core::stringify!(PairFlash)).field(&self.address()).finish()
        }
    }
    ...
    impl ::ethers::core::abi::AbiDecode for PairFlashCalls {
        fn decode(
            ...
            if let Ok(decoded) = <InitFlashCall as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
            ...
            if let Ok(decoded) = <SwapRouterCall as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
            ...
            if let Ok(decoded) = <UniswapV3FlashCallbackCall as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
